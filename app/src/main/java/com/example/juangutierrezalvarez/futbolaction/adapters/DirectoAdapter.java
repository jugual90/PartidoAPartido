 ...
 */
public class DirectoAdapter extends BaseAdapter {
    private Context context;
    private List<Directo> items;

    public DirectoAdapter(Context context, List<Directo> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        Directo item = this.items.get(position);
