...
/**
 * Created by juangutierrezalvarez on 15/5/15.
 */
public class ClasificacionListFragmentPremier extends ListFragment
{
    private final String URL="http://www.resultados-futbol.com/scripts/api/api.php?tz=Europe/Madrid&format=json&req=tables&key=29e84b2983e471c912f660674f66d887&league=10";
